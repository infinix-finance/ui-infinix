...
export interface BasicTokenWithMintInterface extends utils.Interface {
  functions: {
...
export interface BasicTokenWithMint extends BaseContract {
  contractName: "BasicTokenWithMint";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BasicTokenWithMintInterface;
